...
def solve_diffeq_1cc(t, h0, lambda1):
    t_span = [2, t]
    sol = solve_ivp(dh_dt_1cc, t_span=t_span, y0=h0, dense_output=True, args=(lambda1,), rtol=1e-5, atol=1e-9, max_step=1e-6, method='RK45')
    return sol
...
if __name__ == "__main__":
    ...
    lambda1 = lambda t: 0*t

    t = 5
    h0 = [complex(2)]

    sol = solve_diffeq_1cc(t, h0, lambda1)
    print(sol)
